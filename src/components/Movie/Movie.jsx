...
export default class Movie extends Component {
    ...
    changeRating = async (value) => {
        ...
        await fetch(
            `https://api.themoviedb.org/3/movie/${id}/rating?api_key=9ae97e145cfa535e840476b073e34378&guest_session_id=${guestId}`,
            {
                method: 'POST',
                headers: {
    ...
    render() {
        ...
        return (
            <div className="MoviesList__movie" id={id}>
                <div className="imageContainer">
                    <img src={this.checkImage(image)} alt="Здесь могла быть ваша реклама" />
                </div>
                <div className="description">
                    ...
                    <time className="movieDate" dateTime={data}>
